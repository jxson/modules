...
typedef dynamic FixturesGenerator();

class Fixtures {
  static Map<String, FixturesGenerator> _collection = new Map<String, FixturesGenerator>();

  void add(String key, FixturesGenerator function) {
  ...
  dynamic get(String key) {
    ...
    FixturesGenerator function = _collection[key];
    return function();
  }
