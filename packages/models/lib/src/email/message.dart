...
class Message {
  ...
  factory Message.fromJson(Map<String, dynamic> json) {
    ...
    return new Message(
      ...
      isRead: json['isRead'],
      links: links != null ? links.toList() : <Uri>[],
      attachments: attachments != null ? attachments.toList() : <Uri>[],
      recipientList: to != null ? to.toList() : <Mailbox>[],
      ccList: cc != null ? cc.toList() : <Mailbox>[],
    );
  }
