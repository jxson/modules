...
///
// TODO(youngseokyoon): Replace this with a mock Secure storage API.
// https://fuchsia.atlassian.net/browse/SO-87
class LocalStorage {
  static const String _dataFileName = 'storage.json';
  ...
  static Future<Null> put(String key, String value) async {
    _Store store = await _load();
    store[key] = value;
    await store.save();
  }
  ...
  static Future<_Store> _load() async {
